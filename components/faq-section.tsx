  ...
  return (
    <section className="diagonal-bg-dark py-16 md:py-28">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-12 text-[#1a1a1a]">Frequently Asked Questions</h2>

        <div className="space-y-3">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="border border-gray-200/60 rounded-lg overflow-hidden hover:border-[#5a3a7a]/30 transition-colors"
            >
              <button
