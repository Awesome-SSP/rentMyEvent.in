...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Decorative Floating Objects (simplified for pro theme) */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Decorative Circles */}
        <div className="absolute top-1/4 left-1/3 w-20 h-20 rounded-full border-4 border-[#EC4899]/30 animate-ping-slow"></div>
        <div className="absolute bottom-1/4 right-1/4 w-16 h-16 rounded-full border-4 border-[#6366F1]/30 animate-ping-slow" style={{ animationDelay: '1s' }}></div>
        {/* Stars and confetti removed */}
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-screen py-20">
          ...
          <div className="relative" style={{
            ...
            <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
                    ...
                    <div className="absolute inset-0 flex flex-col justify-between p-8">
                      ...
                      <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-6 shadow-xl border border-white/20 animate-slide-up">
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#06B6D4] to-[#3B82F6] flex items-center justify-center animate-bounce-slow">
              ...
              {/* Floating Badge (emoji replaced with icon) */}
              <div className="absolute -top-6 -right-6 animate-float">
                <div className="relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-5 shadow-2xl border border-white/20">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#8B5CF6] to-[#EC4899] flex items-center justify-center animate-bounce-slow">
                        <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                          <path d="M12 2l2.39 4.84L20 8l-4 3.9.95 5.52L12 15.77 7.05 17.42 8 11.9 4 8l5.61-1.16L12 2z"/>
                        </svg>
                      </div>
                      <div>
