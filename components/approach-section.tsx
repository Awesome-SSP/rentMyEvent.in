  ...
  return (
    <section className="section-diag section-diag--b py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          title="How do We Ensure"
          highlight="Your Events Succeed?"
          subtitle="Our approach combines creativity, expertise, and technology to provide smooth and memorable events."
          align="center"
          className="mb-10"
        />
