                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center">
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-[#6B4E71] leading-tight animate-fade-in-up">
                                Our <span className="bg-gradient-to-r from-[#FFB3D9] via-[#E6D5FF] to-[#FF6B9D] bg-clip-text text-transparent">Premium Services</span>
                            </h1>
                            <p className="text-xl text-[#6B4E71] mb-8 max-w-3xl mx-auto animate-fade-in-up animate-delay-200 font-medium">
                                Comprehensive event solutions designed to <span className="text-[#FF6B9D] font-semibold">exceed your expectations</span>
                            </p>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {services.map((service, idx) => {
                                ...
                                return (
                                    <div
                                        key={idx}
                                        className="bg-white rounded-lg border border-pink-200 p-8 card-hover-lift shadow-soft"
                                        style={{ animationDelay: `${(idx + 1) * 0.1}s` }}
                                    >
                                        <Icon className="w-14 h-14 text-[#FF6B9D] mb-4" />
                                        <h3 className="text-2xl font-bold text-[#6B4E71] mb-3">{service.title}</h3>
                                        <p className="text-[#7B5E81] mb-6 font-medium">{service.description}</p>
                                        <ul className="space-y-2">
                                            {service.features.map((feature, fidx) => (
                                                <li key={fidx} className="text-sm text-[#6B4E71] flex items-center gap-2 font-medium">
                                                    <span className="w-2 h-2 bg-[#FFB3D9] rounded-full"></span>
                                                    {feature}
                                                </li>
                                            ))}
                                        </ul>
                ...
                <section className="section-diag section-diag--b py-16 md:py-24">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-[#6B4E71] animate-fade-in-down">
                            Why Choose <span className="bg-gradient-to-r from-[#FFB3D9] to-[#FF6B9D] bg-clip-text text-transparent">Our Services</span>
                        </h2>

                        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                            <div className="animate-fade-in-left">
                                <h3 className="text-xl font-bold text-[#6B4E71] mb-3">Professional Expertise</h3>
                                <p className="text-[#7B5E81] font-medium">
                            ...
                            <div className="animate-fade-in-right animate-delay-200">
                                <h3 className="text-xl font-bold text-[#6B4E71] mb-3">Latest Technology</h3>
                                <p className="text-[#7B5E81] font-medium">
                            ...
                            <div className="animate-fade-in-left animate-delay-300">
                                <h3 className="text-xl font-bold text-[#6B4E71] mb-3">24/7 Support</h3>
                                <p className="text-[#7B5E81] font-medium">
                            ...
                            <div className="animate-fade-in-right animate-delay-400">
                                <h3 className="text-xl font-bold text-[#6B4E71] mb-3">Transparent Pricing</h3>
                                <p className="text-[#7B5E81] font-medium">
                ...
                <section className="diagonal-bg-dark py-16 md:py-24">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-[#6B4E71] animate-fade-in-up">
                            Let's <span className="bg-gradient-to-r from-[#FFB3D9] to-[#FF6B9D] bg-clip-text text-transparent">Bring Your Event to Life</span>
                        </h2>
